...
The Froxlor login page was vulnerable to blind template injection. The vulnerability allowed me to create a new admin user by sending malicious code through the login form.
...
After logging into the Froxlor admin panel with these credentials, I discovered the `web1` user and changed their password. This allowed me to connect to FTP using FileZilla with the new credentials.
